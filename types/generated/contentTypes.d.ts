...
export interface ApiAboutUsAboutUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    about_page: Schema.Attribute.Component<'about.about-page', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    home_about: Schema.Attribute.Component<'about.home-about', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sidebar: Schema.Attribute.Component<'about.sidebar', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiActivityActivity extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tours and activities available in Boquete';
...
export interface ApiContentPageContentPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    accommodations: Schema.Attribute.Component<'global.copies-page', false>;
    activities: Schema.Attribute.Component<'global.copies-page', false>;
    contact_page: Schema.Attribute.Component<'global.visitor-info', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    visitor_info: Schema.Attribute.Component<'global.visitor-info', false>;
  };
}
...
export interface ApiHotelHotel extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Hotels and accommodations in Boquete';
    displayName: 'Hotels';
    pluralName: 'hotels';
    singularName: 'hotel';
  };
...
export interface ApiPackagePackage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hero_packages: Schema.Attribute.Component<'packages.hero-packages', false>;
    link_contact_packages: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::package.package'
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whyPackages: Schema.Attribute.Component<'packages.why-packages', true> &
      Schema.Attribute.SetMinMax<
        {
          max: 4;
        },
...
export interface ApiRestaurantRestaurant extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Kosher restaurants and food establishments';
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['Bakery', 'Restaurant', 'Cafe', 'Deli', 'Catering', 'Market']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiShabbatAndHolidayShabbatAndHoliday
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::shabbat-and-holiday.shabbat-and-holiday'
    > &
      Schema.Attribute.Private;
...
export interface ApiShabbatBoxPageShabbatBoxPage
  extends Struct.SingleTypeSchema {
  collectionName: 'shabbat_box_pages';
  info: {
    displayName: 'ShabbatBox Page';
    pluralName: 'shabbat-box-pages';
    singularName: 'shabbat-box-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::shabbat-box-page.shabbat-box-page'
    > &
      Schema.Attribute.Private;
    picture: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    picture_popup: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    publishedAt: Schema.Attribute.DateTime;
    sidebar: Schema.Attribute.Component<'shabbat-box.sidebar', false>;
...
export interface ApiShabbatBoxShabbatBox extends Struct.CollectionTypeSchema {
  collectionName: 'shabbat_boxes';
  info: {
    description: 'Shabbat box categories and options for delivery';
    displayName: 'Shabbat Box';
    pluralName: 'shabbat-boxes';
    singularName: 'shabbat-box';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::shabbat-box.shabbat-box'
    > &
      Schema.Attribute.Private;
    options: Schema.Attribute.Component<'shabbat-box.option', true> &
      Schema.Attribute.Required;
...
export interface ApiShabbatPricingShabbatPricing
  extends Struct.CollectionTypeSchema {
  collectionName: 'shabbat_pricings';
  info: {
    description: 'Pricing structure for Shabbat meals and services';
    displayName: 'Shabbat Register Pricing';
    pluralName: 'shabbat-pricings';
    singularName: 'shabbat-pricing';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::shabbat-pricing.shabbat-pricing'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
    prices: Schema.Attribute.Component<'pricing.price-option', true> &
      Schema.Attribute.Required;
...
export interface ApiSiteConfigSiteConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    navigateUrl: Schema.Attribute.String;
    ...
    social_media: Schema.Attribute.Component<'global.social-media', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiVisitorInfoVisitorInfo extends Struct.CollectionTypeSchema {
  collectionName: 'visitor_infos';
  info: {
    description: 'Information articles for visitors to Boquete and Chabad services';
    displayName: 'Visitor Info';
    pluralName: 'visitor-infos';
    singularName: 'visitor-info';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::visitor-info.visitor-info': ApiVisitorInfoVisitorInfo;
